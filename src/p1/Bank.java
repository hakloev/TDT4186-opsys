...
/**
 * Created by hakloev on 04/02/15.
 */
public class Bank {
    ...
    /**
     * Creates a new bank, with a number of couriers, and * starts all the couriers.
     */
    ...
    /**
     * Deposit a given amount of money. The money is put in the * night safe. If there is too much money in the night safe,
    ...
    /**
     * Sum up all the reported deposits to find out how much * the couriers claim that they have deposited.
     */
     ...
     * bank for each courier from the command line parameters, and * starts the simulation.
     */
    public static void main(String[] args) {
        ...
        System.out.println("Starting simulation of " +
                nofCouriers + " couriers with " +
                nofVisits + " deposits each.");
